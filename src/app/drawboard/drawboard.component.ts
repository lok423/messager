import {
  ...
  Component, Input, ElementRef, AfterViewInit, ViewChild, Output, EventEmitter,Inject
} from '@angular/core';
...
export class DrawboardComponent implements AfterViewInit {
  ...
  constructor(public thisDialogRef: MatDialogRef<DrawboardComponent>, @Inject(MAT_DIALOG_DATA) public data: string) { }
